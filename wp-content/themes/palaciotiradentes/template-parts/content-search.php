...
// Post types will not show the excerpt on search results page
$restrict_excerpt_on = isset( $essence[ 'opt_dont_show_excerpt_on' ] ) ? (array) $essence[ 'opt_dont_show_excerpt_on' ] : array( 'page' );
$show_excerpt = !in_array( get_post_type(), $restrict_excerpt_on );

?>

<article id="post-<?php the_ID(); ?>" <?php post_class( 'blog-item ' . $postgrid ); ?>>
    ...
    <?php if ( $blog_layout_style == 'standard' ): // Style List ?>
        <div class="row">
            <div class="tr-img-post col-md-6">
            ...
            <div class="tr-content-post col-md-6">
                <div class="info-post">
                    ...
                    <?php echo essence_modify_read_more_link(); ?>
                </div><!-- /.info-post -->
            </div>
        </div>
