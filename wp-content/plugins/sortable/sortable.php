<?php
/*
    Plugin Name: Sortable
    Plugin URI: http://wpicode.com/sortable
...
function sortable_activate() {
		...
		update_option( 'sortable_cache', '20' );
		} else {
		 add_option( 'sortable_cache', '20' );
		}		
		...
		update_option( 'sortable_translate', 'Sort by:|Social Status|Facebook Shares|Twitter Shares|Google Plus Shares|StumbleUpon Shares|LinkedIn Shares|Pinterest Shares|A-Z Alphabetically|Z-A Alphabetically|Newest|Oldest|Most Commented|Read More|Posted|on' );
		} else {
		 add_option( 'sortable_translate', 'Sort by:|Social Status|Facebook Shares|Twitter Shares|Google Plus Shares|StumbleUpon Shares|LinkedIn Shares|Pinterest Shares|A-Z Alphabetically|Z-A Alphabetically|Newest|Oldest|Most Commented|Read More|Posted|on' );
		}			
}
