;(function($) {
    ...
    editor.setOptions({
     ...
     // onscreen plugin.
     $.expr[":"].onScreenFrame=function(n){var t=$(document),o=t.scrollTop(),r=t.height(),c=o+r,f=$(document).find(n),i=f.offset().top,h=f.height(),u=i+h;return i>=o&&c>i||u>o&&c>=u||h>r&&o>=i&&u>=c;}
     ...
     mainDocument.on("keydown",function(e){
          ...
          if (code == 90 && ctrlKey == 1 && tagType == 0){
               ...
               yp_draw();
               setTimeout(function(){yp_draw();},20);
          ...
          if (code == 82 && ctrlKey == 0 && tagType == 0){
               ...
               $(".yp-ruler-btn").toggleClass("active");
               yp_resize();
               return false;
          }
    ...
    editor.setValue(yp_get_clean_css(true));
     ...
     // Tooltip
     $('[data-toggle="tooltip"]').tooltip({animation:false,container: ".yp-select-bar",html:true});
     $('[data-toggle="tooltip-left"]').tooltip({animation:false,placement: 'bottom', container: ".yp-select-bar"});
     $('[data-toggle="popover"]').popover({animation:false,trigger:'hover',container: ".yp-select-bar"});
     $(".yp-none-btn").tooltip({animation:false,container: '.yp-select-bar', title: l18_none});
     $(".yp-element-picker").tooltip({animation:false,placement: 'bottom', container: '.yp-select-bar', title: l18_picker});
     ...
     $(".anim-bar").draggable({handle:".anim-bar-title",stop:function(){$(".anim-bar").addClass("anim-bar-dragged");} });
     ...
     // Only number
     $(document).on('keydown', '.scenes .scene input', function(e){-1!==$.inArray(e.keyCode,[46,8,9,27,13,110,190])||/65|67|86|88/.test(e.keyCode)&&(!0===e.ctrlKey||!0===e.metaKey)||35<=e.keyCode&&40>=e.keyCode||(e.shiftKey||48>e.keyCode||57<e.keyCode)&&(96>e.keyCode||105<e.keyCode)&&e.preventDefault()});
     ...
     $(".yp-animation-creator-start,.yp-anim-save").click(function(){
          ...
          if($("#yp-set-animation-name").val().length == 0){
               $("#set-animation-name-group").popover({title: l18_warning,content:l18_setAnimName,trigger:'click',placement:"left",container: ".yp-select-bar"}).popover("show");
               return false;
          }else{
          ...
          if($("#yp-animation-name-data option[value='"+$("#yp-set-animation-name").val()+"']").length > 0){
               $("#set-animation-name-group").popover({title: l18_warning,content:l18_animExits,trigger:'click',placement:"left",container: ".yp-select-bar"}).popover("show");
               return false;
          }else{
               $("#set-animation-name-group").popover("destroy");
          }
    ...
    $(".input-autocomplete").each(function(){
         ...
         $(this).autocomplete({
               ...
               open: function(event, ui){
                   ...
                   if($(this).parent().find(".autocomplete-div").find('li').filter(function(){return $.text([this]) === current;}).length == 1){

                        $(".active-autocomplete-item").removeClass("active-autocomplete-item");
                        if($(".active-autocomplete-item").length == 0){

                             $(this).parent().find(".autocomplete-div").find('li').filter(function(){return $.text([this]) === current;}).addClass("active-autocomplete-item");
        ...
        if(window.setSelector == false){
          ...
          if(yp_check_with_parents(element,"display","none","equal") == true || yp_check_with_parents(element,"visibility","hidden","equal") == true || yp_check_with_parents(element,"opacity","0","equal") == true){
            ...
            if (body.hasClass("yp-content-selected") == false){
                ...
                // Element Tooltip
                iframeBody.append("<div class='yp-selected-tooltip'><small>" + yp_tag_info(tagName, selectorTag) + "</small> " + $.trim(selectorView) + "</div>");

                // Append setting icon.
                    iframeBody.append("<div class='yp-edit-menu'></div>");
    ...
    function yp_insert_important_rule(selector, id, value, prefix, size){
     ...
     function yp_hide_selects_with_animation(){
          ...
          iframe.find(window.yp_elements).stop().animate({ opacity: 0},200);
     ...
     function yp_show_selects_with_animation(){
          ...
          iframe.find(window.yp_elements).stop().animate({ opacity: 1},200);
    ...
    $(document).on("change", "#yp-animation-name,#yp-animation-play,#yp-animation-iteration-count", function(e){
         ...
         if(iframe.find(".yp-selected").css("display") == "inline"){
              $(this).parent().parent().popover({title: l18_warning,content:l18_animation_notice,trigger:'click',placement:"left",container: ".yp-select-bar"}).popover("show");
         }else{
    ...
    $("#margin-left-group,#margin-right-group,#margin-top-group,#margin-bottom-group").on("mouseenter click",function(e){
         ...
         if(iframe.find(".yp-selected").css("display") == "inline" || iframe.find(".yp-selected").css("display") == "table-cell"){
                  $(this).popover({title: l18_notice,content:l18_margin_notice,trigger:'hover',placement:"left",container: ".yp-select-bar"}).popover("show");
          }else{
    ...
    // Padding maybe not working, because display inline.
     $("#padding-left-group,#padding-right-group,#padding-top-group,#padding-bottom-group").on("mouseenter click",function(e){
         ...
         if(iframe.find(".yp-selected").css("display") == "inline"){
                  $(this).popover({title: l18_notice,content:l18_padding_notice,trigger:'hover',placement:"left",container: ".yp-select-bar"}).popover("show");
          }else{
               $(this).popover("destroy");
          }
     ...
     $("#border-width-group").on("mouseenter click",function(e){
         ...
         if(parseInt($("#border-width-value").val()) <= 0){
                  $(this).popover({title: l18_notice,content:l18_border_width_notice,trigger:'hover',placement:"left",container: ".yp-select-bar"}).popover("show");
          }else{
               $(this).popover("destroy");
          }
     ...
     $("#background-color-group").on("mouseenter click",function(e){
         ...
         if($("#yp-background-image").val() != ''){
                  $(this).popover({title: l18_notice,content:l18_bg_img_notice,trigger:'hover',placement:"left",container: ".yp-select-bar"}).popover("show");
          }else{
               $(this).popover("destroy");
          }
     ...
     $(".background-parallax-div,#background-size-group,#background-repeat-group,#background-attachment-group,#background-position-group").on("mouseenter click",function(e){
         ...
         if($("#yp-background-image").val() == ''){
                  $(this).popover({title: l18_notice,content:l18_bg_img_notice_two,trigger:'hover',placement:"left",container: ".yp-select-bar"}).popover("show");
          }else{
               $(this).popover("destroy");
          }
     ...
     $("#box-shadow-color-group").on("mouseenter click",function(e){
         ...
         if($("#yp-box-shadow-color").val() == ''){
                  $(this).popover({title: l18_notice,content:l18_shadow_notice,trigger:'hover',placement:"left",container: ".yp-select-bar"}).popover("show");
          }else{
               $(this).popover("destroy");
          }
     ...
     $("#border-style-group").on("mouseenter click",function(e){
         ...
         if($("#yp-border-style input:checked").val() == 'hidden' || $("#yp-border-style input:checked").val() == 'none' || $("#yp-border-style input:checked").val() == undefined){
                  $(this).popover({title: l18_notice,content:l18_border_style_notice,trigger:'hover',placement:"left",container: ".yp-select-bar"}).popover("show");
          }else{
               $(this).popover("destroy");
          }
    ...
    function yp_clean() {
         ...
         /* this function remove selected element */
          ...
          body.removeAttr("data-clickable-select").removeAttr("data-yp-selector").removeClass("yp-selector-focus").removeClass("yp-selector-hover").removeClass("yp-left-selected-resizeable").removeClass("yp-css-data-trigger").removeClass("yp-contextmenuopen");
        ...
        iframe.find(".yp-edit-menu,.yp-selected-handle,.yp-selected-others-top,.yp-selected-others-left,.yp-selected-others-right,.yp-selected-others-bottom,.yp-selected-tooltip,.yp-selected-boxed-top,.yp-selected-boxed-left,.yp-selected-boxed-right,.yp-selected-boxed-bottom,.yp-selected-boxed-margin-top,.yp-selected-boxed-margin-left,.yp-selected-boxed-margin-right,.yp-selected-boxed-margin-bottom,.selected-just-it-span,.yp-selected-boxed-padding-top,.yp-selected-boxed-padding-left,.yp-selected-boxed-padding-right,.yp-selected-boxed-padding-bottom").remove();
          ...
          if(!$("body").hasClass("yp-select-just-it")){
               window.selectorClean = null;
          }

          yp_anim_cancel();

          $("*:not(.yp-start-info):not(.yp-other-other-pages)").popover("destroy");
          ...
          if(evt.which == undefined || evt.which == 1){
               ...
               if (body.hasClass("yp-content-selected") == true){
                    ...
                    if(element.hasClass("yp-edit-menu") == true && element.hasClass("yp-content-selected") == false){
                         ...
                         iframe.find(".yp-selected").contextMenu({x:x,y:y});
                         return false;
                    }
