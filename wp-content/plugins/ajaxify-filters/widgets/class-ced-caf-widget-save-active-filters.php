...
class CED_CAF_Widget_Save_Active_Filters extends CED_CAF_Widget 
{
	...
	public function __construct() {
		...
		$this->widget_description = __( 'Shows a widget which lets you save applied filter to be used later.', 'caf_txt_domain' );
		$this->widget_id          = 'ccas_ajax_save_active_filters';
		$this->widget_name        = __( 'AJAX Save Active Filters', 'caf_txt_domain' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( 'Save Active Filters', 'caf_txt_domain' ),
	...
	public function widget( $args, $instance ) 
	{
		...
		echo '</span>';
		echo '<button id="ced_caf_save_active_filters" >Save</button>';
