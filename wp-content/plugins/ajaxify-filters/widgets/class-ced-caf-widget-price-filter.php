...
class CED_CAF_Widget_Price_Filter extends CED_CAF_Widget 
{
	...
	public function __construct() 
	{
		...
		$this->widget_description = __( 'Shows a price filter slider in a widget which lets you search products based on price.', 'caf_txt_domain' );
		$this->widget_id          = 'ccas_ajax_price_filter';
		$this->widget_name        = __( 'AJAX Price Filter', 'caf_txt_domain' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( 'Filter By Price', 'caf_txt_domain' ),
