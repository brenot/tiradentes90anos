...
class CED_CAF_Widget_Pro_Tag_Cloud extends CED_CAF_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = __( 'Shows a Product tags in a widget which lets you search products based on tag.', 'caf_txt_domain' );
		$this->widget_id          = 'ccas_ajax_product_tag_cloud';
		$this->widget_name        = __( 'AJAX Product Tags', 'caf_txt_domain' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( 'Product Tags', 'caf_txt_domain' ),
