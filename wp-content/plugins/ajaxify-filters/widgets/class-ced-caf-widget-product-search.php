...
class CED_CAF_Widget_Product_Search extends CED_CAF_Widget 
{
	...
	public function __construct() 
	{
		...
		$this->widget_description = __( 'Shows a search-box in a widget which lets you search products based text entered.', 'caf_txt_domain' );
		$this->widget_id          = 'ccas_ajax_product_search';
		$this->widget_name        = __( 'AJAX Product Search', 'caf_txt_domain' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( 'Search Products', 'caf_txt_domain' ),
