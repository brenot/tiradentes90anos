...
$ts_vc_anim_effects_out = array(
    __( '--- No Animation ---', 'essence-core' ) => '',
    __( 'bounceOut', 'essence-core' )            => 'bounceOut',
    __( 'bounceOutDown', 'essence-core' )        => 'bounceOutDown',
    __( 'bounceOutLeft', 'essence-core' )        => 'bounceOutLeft',
    __( 'bounceOutRight', 'essence-core' )       => 'bounceOutRight',
    __( 'bounceOutUp', 'essence-core' )          => 'bounceOutUp',
    __( 'fadeOut', 'essence-core' )              => 'fadeOut',
    __( 'fadeOutDown', 'essence-core' )          => 'fadeOutDown',
    __( 'fadeOutDownBig', 'essence-core' )       => 'fadeOutDownBig',
    __( 'fadeOutLeft', 'essence-core' )          => 'fadeOutLeft',
    __( 'fadeOutLeftBig', 'essence-core' )       => 'fadeOutLeftBig',
    __( 'fadeOutRight', 'essence-core' )         => 'fadeOutRight',
    __( 'fadeOutRightBig', 'essence-core' )      => 'fadeOutRightBig',
    __( 'fadeOutUp', 'essence-core' )            => 'fadeOutUp',
    __( 'fadeOutUpBig', 'essence-core' )         => 'fadeOutUpBig',
    __( 'flipOutX', 'essence-core' )             => 'flipOutX',
    __( 'flipOutY', 'essence-core' )             => 'flipOutY',
    __( 'lightSpeedOut', 'essence-core' )        => 'lightSpeedOut',
    __( 'rotateOut', 'essence-core' )            => 'rotateOut',
    __( 'rotateOutDownLeft', 'essence-core' )    => 'rotateOutDownLeft',
    __( 'rotateOutDownRight', 'essence-core' )   => 'rotateOutDownRight',
    __( 'rotateOutUpLeft', 'essence-core' )      => 'rotateOutUpLeft',
    __( 'rotateOutUpRight', 'essence-core' )     => 'rotateOutUpRight',
    __( 'slideOutUp', 'essence-core' )           => 'slideOutUp',
    __( 'slideOutDown', 'essence-core' )         => 'slideOutDown',
    __( 'slideOutLeft', 'essence-core' )         => 'slideOutLeft',
    __( 'slideOutRight', 'essence-core' )        => 'slideOutRight',
    __( 'zoomOut', 'essence-core' )              => 'zoomOut',
    __( 'zoomOutDown', 'essence-core' )          => 'zoomOutDown',
    __( 'zoomOutLeft', 'essence-core' )          => 'zoomOutLeft',
    __( 'zoomOutRight', 'essence-core' )         => 'zoomOutRight',
    __( 'zoomOutUp', 'essence-core' )            => 'zoomOutUp',
    __( 'rollOut', 'essence-core' )              => 'rollOut',
    __( 'hinge', 'essence-core' )                => 'hinge',
);

$ts_vc_anim_effects_in = array(
    __( '--- No Animation ---', 'essence-core' ) => '',
    __( 'bounce', 'essence-core' )               => 'bounce',
    __( 'flash', 'essence-core' )                => 'flash',
    __( 'pulse', 'essence-core' )                => 'pulse',
    __( 'rubberBand', 'essence-core' )           => 'rubberBand',
    __( 'shake', 'essence-core' )                => 'shake',
    __( 'swing', 'essence-core' )                => 'swing',
    __( 'tada', 'essence-core' )                 => 'tada',
    __( 'wobble', 'essence-core' )               => 'wobble',
    __( 'jello', 'essence-core' )                => 'jello',
    __( 'bounceIn', 'essence-core' )             => 'bounceIn',
    __( 'bounceInDown', 'essence-core' )         => 'bounceInDown',
    __( 'bounceInLeft', 'essence-core' )         => 'bounceInLeft',
    __( 'bounceInRight', 'essence-core' )        => 'bounceInRight',
    __( 'bounceInUp', 'essence-core' )           => 'bounceInUp',
    __( 'fadeIn', 'essence-core' )               => 'fadeIn',
    __( 'fadeInDown', 'essence-core' )           => 'fadeInDown',
    __( 'fadeInDownBig', 'essence-core' )        => 'fadeInDownBig',
    __( 'fadeInLeft', 'essence-core' )           => 'fadeInLeft',
    __( 'fadeInLeftBig', 'essence-core' )        => 'fadeInLeftBig',
    __( 'fadeInRight', 'essence-core' )          => 'fadeInRight',
    __( 'fadeInRightBig', 'essence-core' )       => 'fadeInRightBig',
    __( 'fadeInUp', 'essence-core' )             => 'fadeInUp',
    __( 'fadeInUpBig', 'essence-core' )          => 'fadeInUpBig',
    __( 'flip', 'essence-core' )                 => 'flip',
    __( 'flipInX', 'essence-core' )              => 'flipInX',
    __( 'flipInY', 'essence-core' )              => 'flipInY',
    __( 'lightSpeedIn', 'essence-core' )         => 'lightSpeedIn',
    __( 'rotateIn', 'essence-core' )             => 'rotateIn',
    __( 'rotateInDownLeft', 'essence-core' )     => 'rotateInDownLeft',
    __( 'rotateInDownRight', 'essence-core' )    => 'rotateInDownRight',
    __( 'rotateInUpLeft', 'essence-core' )       => 'rotateInUpLeft',
    __( 'rotateInUpRight', 'essence-core' )      => 'rotateInUpRight',
    __( 'slideInUp', 'essence-core' )            => 'slideInUp',
    __( 'slideInDown', 'essence-core' )          => 'slideInDown',
    __( 'slideInLeft', 'essence-core' )          => 'slideInLeft',
    __( 'slideInRight', 'essence-core' )         => 'slideInRight',
    __( 'zoomIn', 'essence-core' )               => 'zoomIn',
    __( 'zoomInDown', 'essence-core' )           => 'zoomInDown',
    __( 'zoomInLeft', 'essence-core' )           => 'zoomInLeft',
    __( 'zoomInRight', 'essence-core' )          => 'zoomInRight',
    __( 'zoomInUp', 'essence-core' )             => 'zoomInUp',
    __( 'rollIn', 'essence-core' )               => 'rollIn',
);
